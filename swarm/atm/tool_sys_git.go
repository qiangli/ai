...
func (r *GitKit) Restore(ctx context.Context, vars *api.Vars, parent *api.Agent, tf *api.ToolFunc, args map[string]any) (any, error) {
	dir, err := api.GetStrProp("dir", args)
	if err != nil {
		return nil, err
	}
	...
	return gitkit.RunGitRestore(gitArgs)
}
