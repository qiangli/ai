...
func setResponseNewParams(params *responses.ResponseNewParams, args api.Arguments) {
	...
	if v, ok := args.Get2("background"); ok {
	...
	if v, ok := args.Get2("max_output_tokens"); ok {
	...
	// ignored.
	if v, ok := args.Get2("max_tool_calls"); ok {
