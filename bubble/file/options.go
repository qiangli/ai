...
type Options struct {
	...
	CursorStyle      style.Styles `embed:"" prefix:"cursor." help:"The cursor style" set:"defaultForeground=196" envprefix:"GUM_FILE_CURSOR_"`
	...
	DirectoryStyle   style.Styles `embed:"" prefix:"directory." help:"The style to use for directories" set:"defaultForeground=231" envprefix:"GUM_FILE_DIRECTORY_"`
	...
	SelectedStyle    style.Styles `embed:"" prefix:"selected." help:"The style to use for the selected item" set:"defaultBold=true" set:"defaultForeground=196" envprefix:"GUM_FILE_SELECTED_"`                    //nolint:staticcheck
	...
	HeaderStyle      style.Styles `embed:"" prefix:"header." set:"defaultForeground=231" envprefix:"GUM_FILE_HEADER_"`
