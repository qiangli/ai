...
// 	log.GetLogger(ctx).Infof("○ fetching url: %q\n", link)
...
// 	log.GetLogger(ctx).Infof("💾 downloading %q to %q \n", link, file)
...
// 	log.GetLogger(ctx).Infof("🦆 ddg query: %q max: %d\n", query, max)
...
// 	log.GetLogger(ctx).Infof("🅱️ bing query: %q max: %d\n", query, max)
...
// 	log.GetLogger(ctx).Infof("🦁 brave query: %q max: %d\n", query, max)
...
// 	log.GetLogger(ctx).Infof("🅖 google query: %q max: %d\n", query, max)
