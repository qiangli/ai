...
type Options struct {
	...
	CursorStyle       style.Styles `embed:"" prefix:"cursor." set:"defaultForeground=196" envprefix:"GUM_CHOOSE_CURSOR_"`
	HeaderStyle       style.Styles `embed:"" prefix:"header." set:"defaultForeground=231" envprefix:"GUM_CHOOSE_HEADER_"`
	ItemStyle         style.Styles `embed:"" prefix:"item." hidden:"" envprefix:"GUM_CHOOSE_ITEM_"`
	SelectedItemStyle style.Styles `embed:"" prefix:"selected." set:"defaultForeground=196" envprefix:"GUM_CHOOSE_SELECTED_"`
