...
type Options struct {
	...
	MatchStyle          style.Styles  `hidden:"" embed:"" prefix:"match." help:"Style the matched text" set:"defaultForeground=212" set:"defaultBold=true" envprefix:"GUM_PAGER_MATCH_"`                                                      //nolint:staticcheck
	MatchHighlightStyle style.Styles  `hidden:"" embed:"" prefix:"match-highlight." help:"Style the matched highlight text" set:"defaultForeground=235" set:"defaultBackground=225" set:"defaultBold=true" envprefix:"GUM_PAGER_MATCH_HIGH_"` //nolint:staticcheck
	Timeout             time.Duration `hidden:"" help:"Timeout until command exits" default:"0s" env:"GUM_PAGER_TIMEOUT"`

	Scroll bool   `help:"Scroll content" default:"true"`
